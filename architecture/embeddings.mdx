...
### SHARC-Embed-Code-001

SHARC's embedding model is optimized for code:

| Property | Value |
|----------|-------|
| Model | SHARC-Embed-Code-001 |
| Dimensions | 4096 |
| Max Tokens | 8192 |
...
4. **Cost-effective**: Competitive pricing vs alternatives
...
1. Check API status at [status.sharc.co](https://status.sharc.co)
2. Verify batch sizes aren't too small
3. Ensure requests are properly batched

### Quality Issues

1. Verify full 4096 dimensions stored
2. Check context injection is working
3. Ensure code isn't truncated at 8K tokens
