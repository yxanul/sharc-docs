...
- **Embeddings** - Generated via Sharc-Embed
- **Vector Storage** - Hybrid search (dense + BM25 sparse)
- **Sync State** - Sync snapshots for incremental updates
...
Use natural prompts in your MCP client, for example:

- `Index this codebase for semantic search.`
- `How does authentication middleware work in this project?`
- `Show indexing status for this repository.`
