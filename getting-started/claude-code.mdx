...
Initial indexing time depends on codebase size. Medium-sized repos (e.g., Hono) take ~30-45 seconds, while large repos (e.g., Next.js) can take 3-4 minutes. Subsequent runs use Merkle diff for near-instant updates.
